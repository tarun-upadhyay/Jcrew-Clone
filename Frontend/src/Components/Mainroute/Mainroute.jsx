...
const Mainroute = () => {
  ...
  <Routes>
    ...
    <Route path='/admin' element={<PrivateRoute><Home/></PrivateRoute>}></Route>
    <Route path='/admin/products' element={<PrivateRoute><AdminProducts/></PrivateRoute>}></Route>
    <Route path='/admin/addproduct' element={<PrivateRoute><AddProduct/></PrivateRoute>}></Route>
